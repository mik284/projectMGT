package com.company.projectmgt.view.projectstats;

import com.company.projectmgt.app.ProjectStatsService;
...
//    @Install(to = "projectStatsesDataGrid.remove", subject = "delegate")
//    private void projectStatsesDataGridRemoveDelegate(final Collection<ProjectStats> collection) {
